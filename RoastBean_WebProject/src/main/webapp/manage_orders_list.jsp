	...
	<section class="inner-page">
	  <div class="container">
		...
		<tr style="border:none;">
		   <th style="text-align: center;" width="80">주문 번호</th>
		   <th style="text-align: center;">회원 아이디</th>
		   <th style="text-align: center;" width="80">제품 번호</th>
		   <th style="text-align: center;" width="100">받는분</th>
		   
		   <th style="text-align: center;">지번</th>
		   <th style="text-align: center;" width="120">주소1</th>
		   <th style="text-align: center;" width="120">주소2</th>
		   <th style="text-align: center;" width="120">주소3</th>
		   
		   <th style="text-align: center;">이메일</th>
		   <th style="text-align: center;">연락처</th>
		   <th style="text-align: center;" width="80">수량</th>
		   <th style="text-align: center;">가격</th>
		   <th style="text-align: center;" width="100">주문일자</th>
		</tr>
		</thead>
		<tbody>
